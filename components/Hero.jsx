      ...
      <div className='wrapper grid grid-cols-1 lg:grid-cols-2 gap-10 justify-center items-center'>
        ...
        <div className='hero-left flex flex-col gap-1 lg:gap-2 justify-between'>
          ...
          <div className='overflow-hidden'>
            ...
            >
              I am Oleksandr Khomenko <br/>FULLSTACK DEVELOPER
          ...
          <div className='overflow-hidden'>
            ...
            >
              As a senior full-stack developer with over 7+ years of extensive experience in web development, I excel at ensuring project perfection. I effectively apply both MongoDB and MySQL databases within modern frameworks such as Next.js and Nuxt.js to create robust solutions.
            </p>
          </div>
          <div>
            <div
